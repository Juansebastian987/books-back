...
public class BooksController {
	...
	public BookDto[] getBooks() {
		...
		return new BookDto[] { new BookDto("Patterns of Enterprise Application Architecture", "Martin Fowler"),
				new BookDto("Clean Architecture: A Craftsman's Guide to Software Structure and Design",
				...
				new BookDto("Agile Software Development: Principles, Patterns, and Practices",
						"Robert C. \"Uncle Bob\" Martin "),
				new BookDto("Introduction to Algorithms",
						"Thomas H. Cormen, Charles E. Leiserson, Ronald L. Rivest, and Clifford Stein "),
				new BookDto("Head First Design Patterns: A Brain-Friendly Guide",
						"Eric Freeman, Elizabeth Robson, Kathy Sierra, and Bert Bales "),
				new BookDto("Cracking the Coding Interview: 189 Programming Questions and Solutions",
						"Gayle Laakmann McDowell "),
				new BookDto("Don't Make Me Think: A Common Sense Approach to Web Usability", "Steve Krug"),
				new BookDto("The Clean Coder: A Code of Conduct for Professional Programmers",
						"Robert C. \"Uncle Bob\" Martin "),
				...
				new BookDto("Design Patterns: Elements of Reusable Object-Oriented Software",
						"Erich Gamma, Richard Helm, and Ralph Johnson"),
				...
				new BookDto("Clean Code: A Handbook of Agile Software Craftsmanship",
						"Robert C. \"Uncle Bob\" Martin "), };
	}
}
